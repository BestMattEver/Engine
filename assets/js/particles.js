var particleSystems = {
    dust: {
        config: {
            particleNumMax: 30, // the maximum number of particles allowable in this system
            particleNumMin: 15, // the minimum number of particles allowable in this system
            systemLife: 10, // life of the system in frames (emission rate is determined by systemLife/number of particles) -1 is ongoing
            ...
            bEnd: 150,
            aEnd: 0,
            xSize: 20, // this is the x size of the emission area, for point emission, use 0
            ySize: 20, // this is the y size of the emission area, for point emission, use 0
         },
        activeEmitters: [
            {},
        ],
